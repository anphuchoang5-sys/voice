...
| 是否已解决 | 解决方式 | 决策人 |
|-----------|---------|--------|
| ✅ 已解决（路径变更） | 实机测试国行 Redmi：无 VPN 错误码 11（服务器断开），有 VPN 错误码 12（zh-CN 语言包缺失）。Google ASR 两条路均不通。阶段八切换为讯飞 SparkChain ASR，国内直连，彻底解决 | 用户+Claude |
